...
int cardEffect(int card, int choice1, int choice2, int choice3, struct gameState *state, int handPos, int *bonus)
{
    ...
    case mine:
        cardEffectMine(choice1, choice2, state, handPos);
    ...
    case minion:
        cardEffectMinion(choice1, choice2, state, handPos);
    ...
    case tribute:
        cardEffectTribute(state);

    case ambassador:
        cardEffectAmbassador(choice1, choice2, state, handPos);
...
int cardEffectTribute(struct gameState *state)
{
    ...
    for (i = 0; i <= 2; i ++) {
        ...
        else if (tributeRevealedCards[i] == estate || tributeRevealedCards[i] == duchy || tributeRevealedCards[i] == province || tributeRevealedCards[i] == gardens ) { //Victory Card Found //**BUG**
            drawCard(currentPlayer, state);
            drawCard(currentPlayer, state);
        }
        else { //Action Card
...
int cardEffectMine(int choice1, int choice2, struct gameState *state, int handPos)
{
    ...
    gainCard(choice2, state, 1, currentPlayer); //**BUG**
